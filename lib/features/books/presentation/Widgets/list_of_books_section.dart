...
import 'package:new_ilearn/features/folders/presentation/managers/get_folder_by_id_cubit.dart';
...
class ListOfBooksSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          GetFolderByIdCubit(useCase: ServiceLocator.instance.getIt()),
      child: Column(
        children: [
          BlocBuilder<GetFolderByIdCubit, CubitStates>(
            builder: (context, state) {

              return state is LoadedState ?GridView.builder(
                shrinkWrap: true,
                ...
                itemBuilder: (context, index) {
                  final List<Items> books=state.data  ;
