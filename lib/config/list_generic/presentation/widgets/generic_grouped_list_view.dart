...
class GenericGroupedListView<CubitType extends CubitListView<T>, T> extends StatelessWidget {
                    ...
                    children: [
                      ...
                      ...List.generate(
                        ...
                        (index) => GestureDetector(
                          onTap: () {},
                          child: itemWidget.call(index, state.data.values.toList()[section][index]),
                        ),
                      )
                    ],
                  );
                    ...
                    return Column(
                      children: [
                        ...
                        ...List.generate(
                          ...
                          (index) => GestureDetector(
                            onTap: () {
                              onItemTapped?.call(state.data.values.toList()[section][index]);
                            },
                            child: Column(
                              children: [itemWidget.call(index, state.data.values.toList()[section][index]), separatorWidget],
                            ),
                          ),
                        )
                      ],
