...
extension IntNullExtension on int? {
  ...
  SizedBox get vs => SizedBox(height: validate.toDouble());
  SizedBox get hs => SizedBox(width: validate.toDouble());
  ...
  bool get isZero => this.orZero == 0;
  get orZero => this ?? 0;
  get isNotZero => this.orZero != 0;
}
