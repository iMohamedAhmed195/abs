...
class TextFiledWidget extends StatelessWidget {
  const TextFiledWidget(
      ...
      this.disabledBorderColor = Colors.black12,this.verticalPadding = 15,this.borderSide=Colors.black12});
    ...
    return TextField(
      ...
      decoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.symmetric(
              vertical: nonBorder == false ? verticalPadding : 0, horizontal: 20),
          filled: true,
          ...
          focusedErrorBorder: nonBorder == false
              ? OutlineInputBorder(
                  borderRadius: BorderRadius.circular(8),
                  borderSide: const BorderSide(color: Colors.red))
              : InputBorder.none,
          errorBorder: nonBorder == false
              ? OutlineInputBorder(
                  borderRadius: BorderRadius.circular(8),
                  borderSide: const BorderSide(color: Colors.red))
              : InputBorder.none,
          focusedBorder: nonBorder == false
              ? OutlineInputBorder(
                  borderRadius: BorderRadius.circular(8),
                  borderSide:  BorderSide(color: borderSide))
              : InputBorder.none,
          enabledBorder: nonBorder == false
              ? OutlineInputBorder(
                  borderRadius: BorderRadius.circular(8),
                  borderSide:  BorderSide(color: borderSide))
              : InputBorder.none,
